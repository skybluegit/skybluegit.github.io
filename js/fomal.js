...
function createtime1() {
  var grt = new Date("06/09/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
  now1.setTime(now1.getTime() + 250);
  var days = (now1 - grt) / 1000 / 60 / 60 / 24;
  var dnum = Math.floor(days);

  var ascll = [
    `欢迎来到Wind Blue Atris'Blog'`,
    `Dream Future `,
    "小站已经苟活",
    dnum,
    "天啦!",
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Fomalhaut🥝 %c 你正在访问Wind Blue Atris'Blog",
...
l = ["非常抱歉，因为不可控原因，博客将于明天停止运营！",   "你的电脑已经过载，建议立即关机！", "你知道吗？站长很喜欢你哦！", "你知道吗，一分钟有61秒哦"]
...
function createtime() {
  ...
  var start = new Date("06/09/2024 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("06/09/2024 00:00:00");
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s2.loli.net/2024/06/10/GXRhMQLmA2C7jZ8.png);
    --darkmode-bg: url(https://s2.loli.net/2024/06/10/wnN6KkJBqWfAa7M.png);
    --mobileday-bg: url(https://s2.loli.net/2024/06/10/5OfxCrbydzmsRe6.png);
    --mobilenight-bg: url(https://s2.loli.net/2024/06/10/nJdl2eEGI4qu1b7.png);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2024/06/09/yVFLDr1gmkXxnlH.png)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2024/06/09/yVFLDr1gmkXxnlH.png)')"></a></div>
              </div>
            </details>
